...
import styles from "../../styles/footerWed.module.css"
import { FaFacebookSquare } from "@react-icons/all-files/fa/FaFacebookSquare"
import { FaInstagram } from "@react-icons/all-files/fa/FaInstagram"

// FooterMain function //
export default function FooterWed() {
  return (
    <footer className={styles.footerWed}>
      {/* Footer content */}
      <div className="row" style={{marginLeft: 0}}>
        <div className="col-lg-4 col-md-4 order-2 col-sm-12 col-xs-12 order-md-1 my-auto">
          <div className="container text-nowrap pr-xs-0" style={{paddingLeft: 0, paddingRight: 0}}>
